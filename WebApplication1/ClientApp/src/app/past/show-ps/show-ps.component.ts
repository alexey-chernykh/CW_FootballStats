...
@Component({
  selector: 'app-show-ps',
  templateUrl: './show-ps.component.html',
  styleUrls: ['./show-ps.component.css']
})
export class ShowPsComponent implements OnInit {
  currDate=new Date();
  upcomingList:any = [];
  matchList:any = [];
  teamList:any=[];
  ...
  AddUpcoming(){
    ...
    this.modalTitle = "Add Past Match";
  ...
  EditUpcoming(item: any){
    this.upcoming = item;
    this.activateAddEditUpCom = true;
    this.modalTitle = "Update Past Match";
  }
