...
@Component({
  selector: 'app-show-td',
  templateUrl: './show-td.component.html',
  styleUrls: ['./show-td.component.css']
})
export class ShowTdComponent implements OnInit {
  currDate=new Date();
  upcomingList:any = [];
  matchList:any = [];
  teamList:any=[];
  ...
  AddUpcoming(){
    ...
    this.modalTitle = "Add Today's Match";
  ...
  EditUpcoming(item: any){
    this.upcoming = item;
    this.activateAddEditUpCom = true;
    this.modalTitle = "Update Today's Match";
  }
